translations = {
    "pl": {
        ...
        "blue_led_hint": "💡 Świeci się niebieska dioda na mostku",
        "bridge_connection_hint": "Upewnij się, że mostek jest podłączony do zasilania i routera.\nPo jego wykryciu naciśnij przycisk na mostku.",
        "start_installation": "Rozpocznij instalację HUE",
        "troubleshooting": "❓ Masz problem?\n- Sprawdź połączenie z siecią lokalną\n- Sprawdź, czy mostek jest zasilany\n- Naciśnij fizyczny przycisk na mostku",
        "bridge_found": "✅ Mostek wykryty: {ip}\n⚠️ Wciśnij przycisk na mostku, aby zakończyć instalację.",
        ...
        "connection_error": "❌ Błąd połączenia z mostkiem: {e}",
        "bridge_searching": "🔍 Szukanie mostka Hue w sieci...",
        "bridge_not_found": "❌ Nie znaleziono mostka.",
        "press_button": "⚠️ Wciśnij przycisk na mostku Hue... (30s)",
    ...
    "en": {
        ...
        "average_temperature": "Average temperature: {avg_temp:.1f}°C",
        ...
        "blue_led_hint": "💡 Blue LED is on the bridge",
        "bridge_connection_hint": "Make sure the bridge is connected to power and router.\nOnce found, press the button on the bridge.",
        "start_installation": "Start HUE installation",
        "troubleshooting": "❓ Having issues?\n- Check your local network connection\n- Ensure the bridge has power\n- Press the physical button on the bridge",
        "bridge_found": "✅ Bridge found: {ip}\n⚠️ Press the button on the bridge to complete setup.",
        ...
        "connection_error": "❌ Connection error with bridge: {e}",
        "bridge_searching": "🔍 Searching for Hue bridge on the network...",
        "bridge_not_found": "❌ No bridge found.",
        "press_button": "⚠️ Press the button on the Hue bridge... (30s)",
        "token_success": "✅ Successfully connected to the bridge!",
        "token_fail": "❌ Failed to obtain token.",
